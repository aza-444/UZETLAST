...
class SiteSettings(models.Model):
    ...
    primary_color = models.CharField(max_length=7, default='#d4890f', help_text='Asosiy brand rangi (hex)', verbose_name='Primary Color')
    accent_color = models.CharField(max_length=7, default='#0e7c9b', help_text='Ikkinchi darajali rang (hex)', verbose_name='Accent Color')
    ...
    bg_section_color = models.CharField(max_length=7, default='#e6edf5', help_text='Bo\'lim foni (alternativ, hex)', verbose_name='Bo\'lim foni')
    text_color = models.CharField(max_length=7, default='#1a2433', help_text='Asosiy matn rangi (hex)', verbose_name='Text Color')
    text_secondary_color = models.CharField(max_length=7, default='#4b5c70', help_text='Ikkinchi darajali matn rangi (hex)', verbose_name='Secondary Text Color')
    border_color = models.CharField(max_length=40, default='rgba(26,36,51,0.09)', help_text='Chegara rangi — rgba yoki hex (masalan: rgba(0,0,0,0.1))', verbose_name='Chegara rangi')
